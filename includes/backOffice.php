  ...
  <li class="nav-item">
    ...
    <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="nav-link" href="bo_yearend.php"><i class="fas fa-hand-holding"></i><span>For Receiving</span></a>
        <a class="nav-link" href="bo_yrEnd_process.php"><i class="far fa-check-circle"></i><span>Received</span></a>
      </div>
    </div>
  </li>
  <li class="nav-item">
