...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    ...
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePOJO" aria-expanded="true" aria-controls="collapsePOJO">
      <i class="fas fa-fw fa-clipboard"></i>
      <span>Submitted PO/JO</span>
    </a>
    <div id="collapsePOJO" class="collapse" aria-labelledby="headingPOJO" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="submit.php">Pending PO/JO</a>
  ...
  <li class="nav-item">
    <a class="nav-link" href="yearend.php">
      ...
      <span>Year-End Report PO/JO</span>
    </a>
  </li>
  <li class="nav-item">
