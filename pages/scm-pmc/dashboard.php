      ...
      <div id="page-body">
                ...
                <div class="row align-items-center">
                  <div class="col mr-2">
                    ...
                    if ($row = $count->fetch(PDO::FETCH_ASSOC)) {
                      echo '<div class="h5 mb-0 font-weight-bold text-gray-800">' . $row['count_pending'] . '</div>';
                    } else {
                    ...
                    <div class="mt-2 mb-0 text-muted text-xs">
                      ...
                      <a class="text-success mr-2" href="submit.php"><i class="fas fa-arrow-up"></i> More Details</a>
                    </div>
                  </div>
                  <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="mt-2 mb-0 text-muted text-xs">
                      ...
                      <a class="text-success mr-2" href="in_process.php"><i class="fas fa-arrow-up"></i> More Details</a>
                    </div>
                  </div>
                  <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="mt-2 mb-0 text-muted text-xs">
                      ...
                      <a class="text-success mr-2" href="for_releasing.php"><i class="fas fa-arrow-up"></i> More Details</a>
                    </div>
                  </div>
                  <div class="col-auto">
        ...
        <div id="req-btn" class="row mb-3">
          <div class="col-md-12">
            ...
            <a type="button" class="btn btn-info" href="../../assets/sample/SampleCSV-v2.xlsm"> Download CSV Sample</a>
