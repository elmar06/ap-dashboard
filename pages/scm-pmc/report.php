        ...
        <div class="container-fluid" id="container-wrapper">
            ...
            <div class="card mb-4 p-3">
                <div id="main-btn" class="row">       
                    <?php
                        if($_SESSION['dept'] == 2){
                            ...
                            //PMC MODULE
                            echo '<div class="col-lg-3">
                                    <button id="pmc-report" class="btn btn-primary" style="width: 100%;"><i class="fas fa-file"></i> Generate PMC Report</button>
                                </div>
                                <div class="col-lg-3">
                                    <button id="report" class="btn btn-warning" style="width: 100%;"><i class="fas fa-file"></i> Disbursement Report</button>
                                </div>';
                ...
                <?php
                    //PMC REPORT MODULE
                    if($_SESSION['dept'] == 1){
                        echo ' <div id="report-div" class="card mb-4 p-3">
                                <div class="row">
                                    <div class="col-lg-12">
                        ...
                        //SCM REPORT MODULE
                        echo '<div id="check" style="display: none;">
                                <div class="row">
                                    <div class="col-lg-3"><br>
                                        <label> Project:</label>
