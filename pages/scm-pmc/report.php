            ...
            <div class="card mb-4 p-3">
                <div id="main-btn" class="row">       
                    <div class="col-lg-3">
                        <?php
                            if($_SESSION['dept'] == 2){
                                echo '<button id="scm-report" class="btn btn-warning" style="width: 100%;"><i class="fas fa-file"></i> Disbursement Report</button>';
                            }else{
                                echo '<button id="pmc-report" class="btn btn-primary" style="width: 100%;"><i class="fas fa-file"></i> Generate PMC Report</button>';
                            }                        
                        ?>
                    </div>
                </div><br>                
                <?php
                    ...
                    if($_SESSION['dept'] == 1){
                        echo ' <div class="card mb-4 p-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <button class="btn btn-success" onclick="generate_report_pmc()" value="1"><i class="fas fa-check"></i> Generate</button>
                                    </div>
                                </div>
                            </div>';
                    }else{
                        //SCM REPORT MODULE
                        echo '<div id="disbursement">
                                <div class="row">
                                    <div class="col-lg-3"><br>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
