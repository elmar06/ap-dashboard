        ...
        <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex justify-content-between mb-4">
                <ol class="breadcrumb" align="right">
                    <li class="breadcrumb-item"><a href="dashboard.php">Executive Assistant</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Reports (EA)</li>
                </ol>
            </div><!-- /Breadcrumbs -->
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <select id="manage-status" class="form-control mb-3 select2" style="width: 100%;">
                                ...
                                <option value="6">For Receiving</option>
                                <option value="8">Returned to Accounting</option>
                            </select>
                        </div>
                        <div class="col-lg-3"><br>
                            <label style="padding-bottom: 23px"> </label>
