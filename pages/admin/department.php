...
<head>
  ...
  <title>AP Dashboard - Department</title>
        ...
        <div class="d-sm-flex justify-content-between mb-4">
          ...
          <div class="col-lg-12">
            <div class="form-group">
              <div class="row">
                &nbsp;&nbsp;&nbsp;
                <button id="btnAdd" class="btn btn-primary btn-block" style="width: 16%" data-toggle="modal" data-target="#newCompany"><i class="fas fa-plus"></i> Add Department</button>&nbsp;
                ...
                <table class="table align-items-center table-flush table-hover dataTable" id="supplier-table">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th style="width: 50%"><center>Department Name</center></th>
...
<div class="modal fade" id="newCompany" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-landmark"></i> Department Details</h5>
        ...
        <div class="modal-body">
            <form>
                <div class="form-group">
                    <input type="text" class="form-control firstname" id="dept-name" placeholder="Department Name">
                </div>
                <!-- Alert -->
...
<!-- Display the details of department modal -->
<div class="modal fade" id="departmentDetailsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-landmark"></i> Department Details</h5>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button id="btnUpdDept" type="button" class="btn btn-primary">Update Details</button>
        </div>
        </div>
    </div>
</div>
...
<?php include 'js/department-js.php'; ?>
