...
// Author : Rex
// 2307 forwarded to compliance 
function received_yearend() {

  var id = $('#notif_po_id').val();
  // alert(id);

  $.ajax({
    type: 'POST',
    url: '../../controls/updated_yearEnd_forReceived.php',
    data: { id: id },
    success: function (response) {
      if (response > 0) {
        toastr.success('Request successfully forwarded to Compliance.');
        setTimeout(function () {
          location.reload();
        }, 1500)
      } else {
