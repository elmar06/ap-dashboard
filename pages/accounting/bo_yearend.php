...
<body id="page-top">
        ...
        <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex justify-content-between mb-4">
                <ol class="breadcrumb" align="right">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Back Office / Year End Report / For Receiving</li>
                </ol>
            </div><!-- /Breadcrumbs -->
            <!-- Pending Card -->
            <div class="row mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div id="notif_message" class="mb-3">
                        <h5 class="text-success"><b>Are you sure you want mark this request as "2307 sent to supplier"?</b></h5>
                    </div>
    ...
    <script src="js/bo_yearend.js"></script>
</body>
