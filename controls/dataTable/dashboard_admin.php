...
$columns = array(
    0=> 'action',
    1 => 'po_details.status',  
    2 => 'check_details.cv_no',
    3 => 'check_details.check_date',
    4 => 'check_details.check_no',
    5 => 'project.project',
    6 => 'company.company',
    7 => 'po_details.po_num',
    8 => 'supplier.supplier_name',
    9 => 'po_details.amount',
);
//$dept_id = $_SESSION['dept'];

//SEARCH
$sql = 'SELECT po_details.id as "po-id", po_details.po_num, po_details.project as "proj-id", po_details.company as "comp-id", po_details.supplier as "supp-id", project.project, company.company FROM po_details, check_details, project, company WHERE po_details.status != 0 AND po_details.company = company.id AND po_details.project = project.id AND po_details.supplier = supplier.id ORDER BY po_details.date_submit DESC';
if(isset($_POST['search']['value'])){
    ...
    $sql .= " OR check_details.cv_no LIKE '%".$search_val."%'";
