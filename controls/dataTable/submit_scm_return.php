...
//SEARCH
$sql = 'SELECT po_details.id as "po-id", po_details.po_num, po_details.si_num, po_details.bill_no, po_details.bill_date, po_details.amount, po_details.status, po_details.submitted_by, po_details.project, company.company, supplier.supplier_name FROM po_details, company, supplier WHERE po_details.company = company.id AND po_details.supplier = supplier.id AND po_details.status = 2';
