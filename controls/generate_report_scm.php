...
$excelData[] = array('COMPANY', 'PROJECT', 'VENDOR', 'PO/JO #', 'SI NO', 'SI/BILLING DATE', 'PO AMOUNT', 'AMOUNT', 'RECEIVED BY', 'DATE RECEIVED ACCT', 'DUE DATE', 'MEMO NO.', 'FORWARD TO EA', 'RETURNED FROM EA', 'DATE RELEASED', 'SUBMITTED BY', 'DATE SUBMIT', 'STATUS'); 
...
if($_GET['action'] == 17)
{
    ...
    //2nd column
    $excelData[] = array('YEAR END REPORT');   
    //3rd column
