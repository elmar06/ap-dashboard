...
class Reports
{
    ...
    public function get_report($comp_id, $from, $to)
    {
        $query = 'SELECT po_details.id as "po-id", po_details.company, po_details.project, po_details.supplier, po_details.or_num, po_details.po_num, po_details.ir_rr_no, po_details.si_num, po_details.po_amount, po_details.amount, po_details.bill_date, po_details.counter_date, po_details.due_date, po_details.memo_no, po_details.date_submit, po_details.status, po_other_details.date_received_fo, po_other_details.date_returned_req, po_other_details.remarks, po_other_details.date_resubmit, po_other_details.2nd_date_received, po_other_details.received_by_fo, po_other_details.date_received_bo, po_other_details.date_to_ea, po_other_details.date_from_ea, po_other_details.date_for_release, po_other_details.date_release, CONCAT(users.firstname, " ", users.lastname) as "fullname" FROM po_details, po_other_details, users WHERE po_details.id = po_other_details.po_id AND po_details.submitted_by = users.id AND po_details.status != 0 AND po_details.company = ? AND (po_other_details.date_to_ea BETWEEN ? AND ?)';
        $this->conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING);
		$sel = $this->conn->prepare($query);

		$sel->execute(array($comp_id, $from, $to));
		return $sel;
    }
    //ACTION - 1
    ...
    {
        $query = 'SELECT po_details.id as "po-id", po_details.company, po_details.project, po_details.supplier, po_details.or_num, po_details.ir_rr_no, po_details.po_num, po_details.si_num, po_details.po_amount, po_details.amount, po_details.bill_date, po_details.counter_date, po_details.due_date, po_details.memo_no, po_details.date_submit, po_details.status, po_other_details.date_received_fo, po_other_details.date_returned_req, po_other_details.remarks, po_other_details.date_resubmit, po_other_details.2nd_date_received, po_other_details.received_by_fo, po_other_details.date_received_bo, po_other_details.date_to_ea, po_other_details.date_from_ea, po_other_details.date_to_manila, po_other_details.date_for_release, po_other_details.date_release, CONCAT(users.firstname, " ", users.lastname) as "fullname" FROM po_details, po_other_details, users WHERE po_details.submitted_by = users.id AND po_details.id = po_other_details.po_id AND po_details.company = ? AND po_details.status != 0 AND (po_details.date_submit BETWEEN ? AND ?)';
        $this->conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING);
		$sel = $this->conn->prepare($query);
    ...
    {
        $query = 'SELECT po_details.id as "po-id", po_details.company, po_details.project, po_details.supplier, po_details.or_num, po_details.po_num, po_details.ir_rr_no, po_details.si_num, po_details.po_amount, po_details.amount, po_details.bill_date, po_details.counter_date, po_details.due_date, po_details.memo_no, po_details.date_submit, po_details.status, po_other_details.date_received_fo, po_other_details.date_returned_req, po_other_details.remarks, po_other_details.date_resubmit, po_other_details.2nd_date_received, po_other_details.received_by_fo, po_other_details.date_received_bo, po_other_details.date_to_ea, po_other_details.date_from_ea, po_other_details.date_to_manila, po_other_details.date_for_release, po_other_details.date_release, CONCAT(users.firstname, " ", users.lastname) as "fullname" FROM po_details, po_other_details, users WHERE po_details.submitted_by = users.id AND po_details.id = po_other_details.po_id AND po_details.status != 0 AND (po_details.date_submit BETWEEN ? AND ?)';
        $this->conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING);
		$sel = $this->conn->prepare($query);
    ...
    {
        $query = 'SELECT po_details.id as "po-id", po_details.company, po_details.project, po_details.supplier, po_details.or_num, po_details.po_num, po_details.ir_rr_no, po_details.si_num, po_details.amount, po_details.bill_date, po_details.counter_date, po_details.due_date, po_details.memo_no, po_details.date_submit, po_details.status, po_other_details.date_received_fo, po_other_details.2nd_date_received, po_other_details.received_by_fo, po_other_details.date_received_bo, po_other_details.date_to_ea, po_other_details.date_to_manila, po_other_details.date_from_ea, po_other_details.date_release, CONCAT(users.firstname, " ", users.lastname) as "fullname" FROM po_details, po_other_details, users WHERE po_details.submitted_by = users.id AND po_details.id = po_other_details.po_id AND po_details.status != 0 AND po_details.project = ? AND po_details.company = ? AND po_details.stat = ? AND (po_details.date_submit BETWEEN ? AND ?)';
        $this->conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING);
		$sel = $this->conn->prepare($query);
    ...
    {
        $query = 'SELECT po_details.id as "po-id", po_details.company, po_details.project, po_details.supplier, po_details.or_num, po_details.po_num, po_details.ir_rr_no, po_details.si_num, po_details.amount, po_details.bill_date, po_details.counter_date, po_details.due_date, po_details.memo_no, po_details.date_submit, po_details.status, po_other_details.date_received_fo, po_other_details.2nd_date_received, po_other_details.received_by_fo, po_other_details.date_received_bo, po_other_details.date_to_ea, po_other_details.date_to_manila, po_other_details.date_from_ea, po_other_details.date_release, CONCAT(users.firstname, " ", users.lastname) as "fullname" FROM po_details, po_other_details, users WHERE po_details.submitted_by = users.id AND po_details.id = po_other_details.po_id AND po_details.project = ? AND po_details.company = ? AND (find_in_set(3, po_details.status) || find_in_set(4, po_details.status) || find_in_set(5, po_details.status) || find_in_set(6, po_details.status) || find_in_set(7, po_details.status) || find_in_set(8, po_details.status)) AND po_details.status != 0 AND (po_details.date_submit BETWEEN ? AND ?)';
        $this->conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING);
		$sel = $this->conn->prepare($query);
    ...
    //AUDIT TRAIL REPORT
    public function save_audit_trail()
    {
        $query = 'INSERT INTO audit_trail SET user_id = ?, po_id = ?, action = ?, remark = ?, date_added = ?, status = 1';
        $this->conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING);
        $save = $this->conn->prepare($query);

        $save->bindParam(1, $this->user_id);
        $save->bindParam(2, $this->po_id);
        $save->bindParam(3, $this->action);
        $save->bindParam(4, $this->remark);
        $save->bindParam(5, $this->date_added);
